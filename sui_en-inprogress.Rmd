...
Considering how little observations were recorded in 2016, it was decided to omit this year in further analysis. The low number of observations would affect the end result and cause it to be unreliable.
```{r}
masterdata %>% 
...
## Data cleaning - the 'country' variable

The next step was to obtain information about the number of observations collected in each country. The results have been sorted according to that number, from lowest to highest.
```{r message=FALSE}
masterdata %>% 
  select(country) %>% 
  group_by(country) %>% 
...
It was decided not to take into the account those countries, whose number of observations wasn't higer than 36. As a result, 7 countries were omitted in the further analysis. 
